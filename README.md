[1]: https://raw.githubusercontent.com/ehengao/assets/master/machinery/example_worker.png
[2]: https://raw.githubusercontent.com/ehengao/assets/master/machinery/example_worker_receives_tasks.png
...
[![Travis Status for ehengao/machinery](https://travis-ci.org/ehengao/machinery.svg?branch=master&label=linux+build)](https://travis-ci.org/ehengao/machinery)
[![godoc for ehengao/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/ehengao/machinery/v1)
[![codecov for ehengao/machinery](https://codecov.io/gh/ehengao/machinery/branch/master/graph/badge.svg)](https://codecov.io/gh/ehengao/machinery)

[![Go Report Card](https://goreportcard.com/badge/github.com/ehengao/machinery)](https://goreportcard.com/report/github.com/ehengao/machinery)
[![GolangCI](https://golangci.com/badges/github.com/ehengao/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for ehengao/machinery](https://sourcegraph.com/github.com/ehengao/machinery/-/badge.svg)](https://sourcegraph.com/github.com/ehengao/machinery?badge)
...
```sh
go get github.com/ehengao/machinery/v1
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/ehengao/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/ehengao/machinery/v1/log` package:
