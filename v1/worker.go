...
import (
	...
	"github.com/ehengao/machinery/v1/backends"
	"github.com/ehengao/machinery/v1/log"
	"github.com/ehengao/machinery/v1/retry"
	"github.com/ehengao/machinery/v1/tasks"
	"github.com/ehengao/machinery/v1/tracing"
)
...
func (worker *Worker) LaunchAsync(errorsChan chan<- error) {
	...
	if cnf.AMQP != nil {
		...
		log.INFO.Printf("  - Concurrency: %d", worker.Concurrency)
	}
